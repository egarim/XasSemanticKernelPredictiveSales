...
namespace XasSemanticKernelPredictiveSales.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XasSemanticKernelPredictiveSalesModule : ModuleBase {
    public XasSemanticKernelPredictiveSalesModule() {
        //
        // XasSemanticKernelPredictiveSalesModule
        //
